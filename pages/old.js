        ...
        <div className='container'>
              ...
              <div className={classNames('container', styles.order_img)}>
                ...
                <div className='row'>
                  <div className={classNames('col-12')}>
                    <h2 className={classNames(styles.txt_sm, styles.txt_sm_pm)}>
                      Hire the top 1% of 300,000+ remote developers using
                      Iramai's Intelligent Talent Cloud. Iramai offers Silicon
                      Valley-caliber engineers with a 100% risk-free two-week
                      trial.
                    </h2>
                  </div>
                </div>
                ...
                <div className='row'>
                  <div className={classNames('col-12', styles.padding_btn)}>
                    <span className={styles.txt_sm}>
                      Looking for jobs instead?
                      <Link href='#'>Apply to jobs</Link>
                    </span>
                  </div>
                </div>
              </div>
              <img
                className={classNames(styles.img, styles.animate)}
                src='/icons/Group_1471.svg'
                alt=''
              />
            </div>
          </div>
                ...
                <div className={styles.section}>
                  ...
                  <div className='how-it-works-text how-it-works-text-1'>
                    ...
                    <p className={styles.txt_sm}>
                      Built by engineering leaders from Facebook, Google,
                      Microsoft, and Stanford, Iramai’s intelligent vetting
                      engine evaluates developers for a Silicon Valley bar.
                    </p>
                  </div>
                </div>
                <div className={styles.section}>
                  ...
                  <div className='how-it-works-text how-it-works-text-2'>
                    ...
                    <p className={styles.txt_sm}>
                      Using assessment tests and automated vetting flow,
                      Iramai’s Intelligent Talent Cloud matches most companies
                      with developers within three days.
                    </p>
                  </div>
                </div>
                <div className={styles.section}>
                  ...
                  <div className='how-it-works-text how-it-works-text-3'>
                    ...
                    <p className={styles.txt_sm}>
                      Whether it is daily stand-ups, productivity trackers,
                      billing, or simply just working with developers in your
                      timezone, Iramai has you covered.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className={classNames('container', styles.turing_demo)}>
              <div className={styles.turing_demo_title}>
                <div className={classNames(styles.txt_lg)}>
                  Iramai Deep
                  <br /> Developer Profiles
                </div>
                <div className={classNames(styles.txt_sm)}>
                  Our in-depth resumes help you know your next developers
                  better. Explore their strengths and weaknesses with our Deep
                  Developer Profiles and decide if they are a good fit for your
                  team.
                </div>
                <div className={styles.padding_btn}>
                  <a
          ...
          <div className='row'>
            <div className={classNames('container', styles.talent)}>
              <div className={styles.talent_title}>
                ...
                <div className={classNames(styles.txt_sm)}>
                  Sourced by software, vetted by software and managed by
                  software.
                </div>
                <div className={styles.padding_btn}>
                  <a
              ...
              <div className={styles.talent_img}>
                <img
                  className={styles.talent_img_content}
                  src='/icons/dev_desk.svg'
                />
              </div>
            </div>
          </div>
          <div className='row'>
            <div className={classNames('container', styles.talent)}>
              ...
              <div className={styles.talent_title}>
                ...
                <div className={classNames(styles.txt_sm)}>
                  Hire the best talent in the world, not the best talent that
                  happens to live near your office. Go #Boundaryless with us and
                  hire across tech roles, skills, and seniority with the push of
                  a button.
                </div>
                <div className={styles.padding_btn}>
                  <a
          ...
          <div className='row'>
            <div className={classNames('container', styles.partner)}>
              <div>
                "As remote work continues to solidify its place as a critical
                aspect of how businesses exist these days, a startup..."
              </div>
